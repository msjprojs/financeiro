...
from .views import InstituicaoViewSet, ContaViewSet, TipoAtivoViewSet, AtivoViewSet, LancamentoViewSet, MovimentacaoContaViewSet, TransferenciaViewSet, TransferenciaFinanceiraViewSet
...
router.register(r'transferenciafinanceira', TransferenciaFinanceiraViewSet, basename='transferenciafinanceira')   
